...
"use client";
;
const STATUS_URL = "https://hallucination.calmwave-93bbec10.brazilsouth.azurecontainerapps.io/status";
function PeopleCounter() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PeopleCounter.useEffect": ()=>{
            const fetchStatus = {
                "PeopleCounter.useEffect.fetchStatus": async ()=>{
                    try {
            ...
            }["PeopleCounter.useEffect.fetchStatus"];
            fetchStatus();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-sm text-zinc-400 uppercase tracking-wide",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "mt-2 text-5xl font-bold text-green-400",
                children: count
            }, void 0, false, {
                fileName: "[project]/dashboard/app/components/PeopleCounter.tsx",
                lineNumber: 32,
...
function SceneState() {
    _s();
    const [scene, setScene] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("UNKNOWN");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SceneState.useEffect": ()=>{
            const fetchStatus = {
                "SceneState.useEffect.fetchStatus": async ()=>{
                    try {
                        const res = await fetch(STATUS_URL, {
                            cache: "no-store"
                        });
                        const data = await res.json();
                        setScene(data.scene_state ?? "UNKNOWN");
                    } catch  {
                        setScene("UNKNOWN");
                    }
                }
            }["SceneState.useEffect.fetchStatus"];
            fetchStatus();
            const interval = setInterval(fetchStatus, 1000);
            return ({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "mt-3 text-xl font-semibold text-blue-400",
                children: scene.replaceAll("_", " ")
            }, void 0, false, {
                fileName: "[project]/dashboard/app/components/SceneState.tsx",
                lineNumber: 32,
                columnNumber: 7
...
_s(SceneState, "NsplukHXYi75Xb6+7jH5A5vo/3k=");
_c = SceneState;
var _c;
...
//# sourceMappingURL=dashboard_0ab99b30._.js.map